 ...
 *******************************************************************************/
package com.cetian.module.task.web;
...
import com.cetian.module.task.service.TaskService;
...
public class TaskController {
	...
	public String create(@Valid Task newTask, RedirectAttributes redirectAttributes) {
		SystemUser user = new SystemUser(getCurrentUserId());
		newTask.setSystemUser(user);
